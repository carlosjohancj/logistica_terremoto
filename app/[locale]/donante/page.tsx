...
export default function DonantePage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
      ...
      <h1 className="text-2xl font-bold">Panel de Donante</h1>
      <p className="text-muted-foreground text-center max-w-md">
        Esta sección está en construcción. Pronto podrás gestionar tus donaciones e insumos ofrecidos desde aquí.
      </p>
    </div>
  )
}

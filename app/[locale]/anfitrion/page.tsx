...
export default function AnfitrionPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
      ...
      <h1 className="text-2xl font-bold">Panel de Anfitrión</h1>
      <p className="text-muted-foreground text-center max-w-md">
        Esta sección está en construcción. Pronto podrás gestionar tus hospedajes y familias alojadas desde aquí.
      </p>
    </div>
  )
}

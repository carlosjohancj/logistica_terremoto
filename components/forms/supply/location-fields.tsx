...
interface SupplyLocationFieldsProps {
  ...
  setValue: UseFormSetValue<SupplyValues>
  stateError?: string
}

export function SupplyLocationFields({ control, setValue, stateError }: SupplyLocationFieldsProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <FormField label={t("state")} required error={stateError}>
        {(field) => (
          <Controller
            name="state"
            control={control}

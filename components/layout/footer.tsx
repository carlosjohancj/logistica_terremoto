    ...
    <footer className="border-t border-border bg-secondary/50">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            {/* logo-main.png has ~68px of transparent padding above the mark
                and a tagline below it; crop to just the icon+wordmark so it
                lines up with the column titles */}
            <div className="mb-3 h-18.5 w-40 overflow-hidden">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="https://backend.desdecerovenezuela.org/storage/v1/object/public/general/logos/logo-main.png"
                alt="Desde Cero"
